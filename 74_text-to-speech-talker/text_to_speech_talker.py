"""Text To Speech Talker, by Al Sweigart
An example program using the text-to-speech features of the pyttsx3
module.
View this code at https://nostarch.com/b-g-book-small-python-projects
Tags: tiny, beginner"""
...
print('Text To Speech Talker, originally by Al Sweigart')
print('Text-to-speech using the pyttsx3 module, which in turn uses')
print('the NSSpeechSynthesizer (on macOS), SAPIS (on Windows), or')
