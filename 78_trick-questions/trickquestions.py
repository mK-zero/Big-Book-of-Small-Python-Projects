"""Trick Questions, by Al Sweigart
...
QUESTIONS = [
    ...
    },
    {
        ...
        'answer' : "Once. Then you are folding in quarters.",
        'accept' : ['one', '1', 'once']
    },
    {
    ...
    {
        'question': "How many miles must a cyclist bike to get to training?",
    ...
    {
        'question': "What do you get if divide one hundred by half.",
    ...
    {
        'question': "Who is the current U.S. President if the U.S. Vice President dies?",
...
print('''Trick Questions, originally by Al Sweigart
